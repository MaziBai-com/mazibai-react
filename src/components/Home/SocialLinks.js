  ...
  return (
    <>
      <div className="side_bar_book">
          ...
          <div className="li" ><a style={{backgroundColor:'#25D366',color:'white'}} href="https://wa.me/+919511836323?text=Welcome to MaziBai! Start Booking Now." target="blank" rel="noreferrer" ><i className="fab fa-whatsapp"></i><span
